...
static const char *const yytname[] =
{
  ...
  "LESS", "GREAT", "AMPERSAND", "PIPE", "$accept", "cmd", "arg",
  "arg_list", "io_modifier_opt", "redirection", "simple_command", YY_NULLPTR
};
#endif
